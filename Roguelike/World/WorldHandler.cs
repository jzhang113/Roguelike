...
namespace Roguelike.World
{
    ...
    class WorldHandler
    {
        ...
        public WorldHandler(WorldParameter parameters, int seed)
        {
            ...
            _currentLevel = parameters.StartLevel;
            // TODO: starting level name, what do?
            _currentLevel.Name = "a";
        ...
        private Dictionary<LevelId, LevelData> BuildWorld(WorldParameter parameters)
        {
            ...
            foreach (WorldParameter.Region region in parameters.Regions)
            {
                ...
                {
                    // TODO: generate and assign level names
                    // TODO: store and retrieve level ids to connect branches
